...
CREATE POLICY "All authenticated users All actions" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users All operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users to SELECT" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
